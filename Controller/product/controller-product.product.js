$(document).ready(function () {
  ...
  fetchProduct("fetch-product", limitDefault, "1", {
    filterName: "",
    filterCate: "",
    filterPriceMin: "0",
  ...
  $(document).on(
    "click",
    ".Product__Page__Content__Right__Product__Paging__Item",
    function () {
      ...
      var filterCate = $(
        ".Product__Page__Content__Left__Filter__Cate__Item.active"
      ).attr("value");
      var filterRam = $(
        ".Product__Page__Content__Left__Filter__Ram__Item.active"
      ).attr("value");
      var filterRom = $(
        ".Product__Page__Content__Left__Filter__Rom__Item.active"
      ).attr("value");
      var filterBattery = $(
        ".Product__Page__Content__Left__Filter__Pin__Item.active"
      ).attr("value");
      var filterCamera = $(
        ".Product__Page__Content__Left__Filter__Camera__Item.active"
      ).attr("value");
      var filterBranch = $(
        ".Product__Page__Content__Left__Filter__Branch__Item.active"
      ).attr("value");
      var filterSortPrice = $(
        ".Product__Page__Content__Left__Filter__SortPrice__Item.active"
      ).attr("value");
  ...
  $(".Product__Page__Content__Left__Filter__SortPrice__Item").click(
    function () {
      $(".Product__Page__Content__Left__Filter__SortPrice__Item").map(
        function () {
          $(this).removeClass("active");
        }
      );
  ...
  document
    .querySelector(".Product__Page__Content__Left__Filter__Reset")
    .addEventListener("click", function () {
      ...
      // Chuyển hướng đến trang không có bộ lọc, giữ lại keyword nếu có
