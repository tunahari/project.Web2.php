$(document).ready(function() {
    ...
    $('.Profile__Save__Info__Button').click(function() {
        ...
        if (flagText === 2 && flagNumber === 1 && flagDate === 1 && flagPhone === 1 && flagEmail === 1) {
            var employeeProfile = {
            ...
            ClassFuction.getAjaxPost('../../Controller/admin/controller-admin.profile.php', 
            {
                ...
                if (response.trim() === 'update-success') {
                    ...
                    setTimeout(function() {
                        $('.loading__box').hide()
                        alertSuccess ('Cập nhật thông tin của bạn thành công!')
                    },2500)
                    ...
                    if (dataResponse[4] !== '') {
                        setTimeout(function() {
                            $('.loading__box').hide()
                            alertFailed ('Cập nhật thông tin của bạn thất bại!')
                        },2500)  
                    }
                }
            });
    ...
    $('#submitUpdateAvatarEmployee').click(function() {
        var dataResponse = handlingFunctions.getAjaxFile ('../../Controller/admin/controller-admin.profile.php', 
