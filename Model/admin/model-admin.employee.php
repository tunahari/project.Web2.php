...
class Employee
{
    ...
    public function setNV_IDNhanVien($NV_IDNhanVien)
    {
        $this->NV_IDNhanVien = $NV_IDNhanVien;
    }
    public function setNV_TenNhanVien($NV_TenNhanVien)
    {
        $this->NV_TenNhanVien = $NV_TenNhanVien;
    }
    public function setNV_SoDienThoaiNhanVien($NV_SoDienThoaiNhanVien)
    {
        $this->NV_SoDienThoaiNhanVien = $NV_SoDienThoaiNhanVien;
    }
    public function setNV_DiaChiNhanVien($NV_DiaChiNhanVien)
    {
        $this->NV_DiaChiNhanVien = $NV_DiaChiNhanVien;
    }
    public function setNV_EmailNhanVien($NV_EmailNhanVien)
    {
        $this->NV_EmailNhanVien = $NV_EmailNhanVien;
    }
    public function setNV_NgaySinhNhanVien($NV_NgaySinhNhanVien)
    {
        $this->NV_NgaySinhNhanVien = $NV_NgaySinhNhanVien;
    }
    public function setNV_GioiTinhNhanVien($NV_GioiTinhNhanVien)
    {
        $this->NV_GioiTinhNhanVien = $NV_GioiTinhNhanVien;
    }
    public function setNV_MaChiNhanh($NV_MaChiNhanh)
    {
        $this->NV_MaChiNhanh = $NV_MaChiNhanh;
    }
    public function setNV_ChucVuNhanVien($NV_ChucVuNhanVien)
    {
        $this->NV_ChucVuNhanVien = $NV_ChucVuNhanVien;
    }
    public function setNV_NgayTaoNhanVien($NV_NgayTaoNhanVien)
    {
        $this->NV_NgayTaoNhanVien = $NV_NgayTaoNhanVien;
    }
    public function setNV_AvatarNhanVien($NV_AvatarNhanVien)
    {
        $this->NV_AvatarNhanVien = $NV_AvatarNhanVien;
    }
    public function setNV_GioiThieuNhanVien($NV_GioiThieuNhanVien)
    {
        $this->NV_GioiThieuNhanVien = $NV_GioiThieuNhanVien;
    }
    public function setNV_FacebookNhanVien($NV_FacebookNhanVien)
    {
        $this->NV_FacebookNhanVien = $NV_FacebookNhanVien;
    }
    public function setNV_TwitterNhanVien($NV_TwitterNhanVien)
    {
        $this->NV_TwitterNhanVien = $NV_TwitterNhanVien;
    }
    public function setNV_LinkedNhanVien($NV_LinkedNhanVien)
    {
        $this->NV_LinkedNhanVien = $NV_LinkedNhanVien;
    }
    public function setNV_DeleteStatusNhanVien($NV_DeleteStatusNhanVien)
    {
        $this->NV_DeleteStatusNhanVien = $NV_DeleteStatusNhanVien;
    }
    public function setNV_MatKhauNhanVien($NV_MatKhauNhanVien)
    {
        $this->NV_MatKhauNhanVien = $NV_MatKhauNhanVien;
    }
    public function setNV_XacThucEmailNhanVien($NV_XacThucEmailNhanVien)
    {
        $this->NV_XacThucEmailNhanVien = $NV_XacThucEmailNhanVien;
    }
    public function setNV_TrangThaiTaiKhoanNhanVien($NV_TrangThaiTaiKhoanNhanVien)
    {
        $this->NV_TrangThaiTaiKhoanNhanVien = $NV_TrangThaiTaiKhoanNhanVien;
    }
    public function setNV_TrangThaiDangNhapNhanVien($NV_TrangThaiDangNhapNhanVien)
    {
        $this->NV_TrangThaiDangNhapNhanVien = $NV_TrangThaiDangNhapNhanVien;
    }
    public function setNV_MaChoXacThucNhanVien($NV_MaChoXacThucNhanVien)
    {
        $this->NV_MaChoXacThucNhanVien = $NV_MaChoXacThucNhanVien;
    }
    ...
    {
        $ConnectDataBase = new ConnectDataBase;
        $sql = "INSERT INTO employee (NV_TenNhanVien, NV_SoDienThoaiNhanVien, NV_DiaChiNhanVien, NV_EmailNhanVien, NV_NgaySinhNhanVien, NV_GioiTinhNhanVien, NV_MaChiNhanh, NV_ChucVuNhanVien, NV_NgayTaoNhanVien, NV_AvatarNhanVien, NV_GioiThieuNhanVien, NV_FacebookNhanVien, NV_TwitterNhanVien, NV_LinkedNhanVien, NV_DeleteStatusNhanVien, NV_MatKhauNhanVien, NV_TrangThaiTaiKhoanNhanVien, NV_TrangThaiDangNhapNhanVien) VALUES (:NV_TenNhanVien, :NV_SoDienThoaiNhanVien, :NV_DiaChiNhanVien, :NV_EmailNhanVien, :NV_NgaySinhNhanVien, :NV_GioiTinhNhanVien, :NV_MaChiNhanh, :NV_ChucVuNhanVien, :NV_NgayTaoNhanVien, :NV_AvatarNhanVien, :NV_GioiThieuNhanVien, :NV_FacebookNhanVien, :NV_TwitterNhanVien, :NV_LinkedNhanVien, :NV_DeleteStatusNhanVien, :NV_MatKhauNhanVien, :NV_TrangThaiTaiKhoanNhanVien, :NV_TrangThaiDangNhapNhanVien)";
        ...
        try {
            ...
            if ($conn) { // Kiểm tra kết nối
                ...
                if ($lastInsertId > 0) {
                    return ['status' => 'success', 'employeeId' => $lastInsertId];
                } else {
                    return ['status' => 'failed', 'error' => 'Lỗi khi lấy ID vừa chèn'];
                }
            } else {
                return ['status' => 'failed', 'error' => 'Lỗi kết nối cơ sở dữ liệu'];
            }
        } catch (PDOException $e) {
            error_log("Lỗi trong hàm insertEmployee(): " . $e->getMessage());
            return ['status' => 'failed', 'error' => 'Lỗi cơ sở dữ liệu: ' . $e->getMessage()];
        }
        try {
            $conn = $ConnectDataBase->connectDB();
            $stmt = $conn->prepare($sql);
            ...
            if ($lastInsertId > 0) {
                ...
                error_log("Lỗi insertEmployee(): lastInsertId() trả về 0. ErrorInfo: " . print_r($errorInfo, true) . " - SQL: " . $sql);
                return ['status' => 'failed', 'error' => 'Lỗi khi chèn dữ liệu hoặc lấy ID'];
            }
        } catch (PDOException $e) {
            error_log("Lỗi insertEmployee(): " . $e->getMessage() . " - SQL: " . $sql);
            return ['status' => 'failed', 'error' => 'Lỗi cơ sở dữ liệu: ' . $e->getMessage()];
        }
    }
    ...
    function setDeleteStatusEmployeeByID()
    {
        ...
        // }
        $ConnectDataBase = new ConnectDataBase;
        // Thay đổi từ UPDATE thành DELETE
        $sql = "DELETE FROM employee WHERE NV_IDNhanVien = :NV_IDNhanVien";
        $stmt = $ConnectDataBase->connectDB()->prepare($sql);
        $stmt->bindParam(':NV_IDNhanVien', $this->NV_IDNhanVien);
        if ($stmt->execute()) {
            return true;
